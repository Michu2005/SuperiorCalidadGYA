...
public class Catalogos {
    ...
    public ResponseEntity<ResponseDTO<Maquina>> crearMaquina(@Validated @RequestBody MaquinaDTO dto,
    ...
    public ResponseEntity<ResponseDTO<Perfil>> crearPerfil(@Validated @RequestBody PerfilDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<Empleado>> crearEmpleado(@Validated @RequestBody EmpleadoDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<Producto>> crearProducto(@Validated @RequestBody ProductoDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<Proceso>> crearProceso(@Validated @RequestBody ProcesoDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<Parametro>> crearParametro(@Validated @RequestBody ParametroDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<TipoParametro>> crearTipoParametro(@Validated @RequestBody TipoParametroDTO dto,
            BindingResult errors) {
    ...
    public ResponseEntity<ResponseDTO<PerfilEmpleado>> crearPerfilEmpleado(
            @Validated @RequestBody PerfilEmpleadoDTO dto, BindingResult errors) {
    ...
    public ResponseEntity<ResponsePaginatedDTO<List<ProductoParametroDTO>>> listarProductoParametro(
        ...
        ResponsePaginatedDTO<List<ProductoParametroDTO>> result = productoParametroService.listarProductoParametro(page,
                size);
        return new ResponseEntity<>(result, result.getHttpStatus());
    }

    @PostMapping(value = "crear/productoParametro")
    public ResponseEntity<ResponseDTO<ProductoParametro>> crearProductoParametro(
            @Validated @RequestBody ProductoParametroDTO dto, BindingResult errors) {
    ...
    public ResponseEntity<Integer> obtenerIdPorCodigoEmpleado(
            @RequestParam(value = "codigoEmpleado") String codigoEmpleado) {
    ...
    public ResponseEntity<List<CabeceraProcesoDTO>> listarProceso(@RequestBody FiltroProductosDTO filtro) {
        List<CabeceraProcesoDTO> result = new ArrayList<>();
        try {
            result = supervisorService.listaProcesoDTO(filtro);
        } catch (Exception e) {
    ...
    @PostMapping("listarEmpaque")
    public ResponseEntity<List<CabeceraEmpaqueDTO>> listarEmpaque(@RequestBody FiltroProductosDTO filtro) {
        System.out.println("Data controller: " + filtro);
        List<CabeceraEmpaqueDTO> result = new ArrayList<>();
        try {
            result = supervisorService.listaEmpaqueDTO(filtro);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return ResponseEntity.ok(result);
    ...
    @PostMapping("/detalleEmpaque/editar")
    public String editar(@RequestBody DetalleEmpaqueDTO detalleEmpaque) {
        try {
            supervisorService.editarDetalleEmpaque(detalleEmpaque);
        } catch (Exception e) {
            throw new RuntimeException("No se puede editar el registro " + detalleEmpaque.getIdDetalle());
        }
        return "El Registro se modifico satisfactoriamente!!";
    }

    @PostMapping("/detalleProceso/editar")
    public String editar(@RequestBody DetalleProcesoDTO detalleProceso) {
        try {
            supervisorService.editarControlProductoDetalle(detalleProceso);
        } catch (Exception e) {
            throw new RuntimeException("No se puede editar el registro " + detalleProceso.getId());
        }
        return "El Registro se modifico satisfactoriamente!!";
    }

    @GetMapping("listarAnalistaPorSupervisorProducto/{id}")
    public List<EmpleadoDTO> listarAnalistaPorSupervisorProducto(@PathVariable("id") int id) {
        List<EmpleadoDTO> retorno = new ArrayList<>();
        try {
            retorno = supervisorService.listarAnalistaPorSupervisorProducto(id);
        } catch (Exception e) {
            throw new RuntimeException("No se pudieron obtener datos con el id: " + id);
        }
        return retorno;
    }
    
    @GetMapping("listarAnalistaPorSupervisorEmpaque/{id}")
    public List<EmpleadoDTO> listarAnalistaPorSupervisorEmpaque(@PathVariable("id") int id) {
        List<EmpleadoDTO> retorno = new ArrayList<>();
        try {
            retorno = supervisorService.listarAnalistaPorSupervisorEmpaque(id);
        } catch (Exception e) {
            throw new RuntimeException("No se pudieron obtener datos con el id: " + id);
        }
        return retorno;
    }
    @GetMapping("obtenerPerfilEmpleado/{codigoEmpleado}")
    public EmpleadoDTO obtenerPerfilEmpleado(@PathVariable("codigoEmpleado") String codigoEmpleado) {
        EmpleadoDTO retorno = new EmpleadoDTO();
        try {
            retorno = empleadoService.listarAnalistaPorSupervisor(codigoEmpleado);
        } catch (Exception e) {
            throw new RuntimeException("No se han encontrado registros con el codigo empleado: " + codigoEmpleado);
        }
        return retorno;
    }
    
    @GetMapping("obtenerListaProductos")
    public ResponsePaginatedDTO<List<ProductoDTO>> obtenerListaProductos() {
        ResponsePaginatedDTO<List<ProductoDTO>> retorno = new ResponsePaginatedDTO<>();
        try {
            retorno = productoService.listarProducto();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return retorno;
